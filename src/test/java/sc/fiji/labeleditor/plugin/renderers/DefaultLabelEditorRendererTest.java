...
public class DefaultLabelEditorRendererTest<T extends RealType<T> & NativeType<T>> {
	...
	public void testMixColors() {
		...
		int colorNoTag = DefaultLabelEditorRenderer.mixColorsOverlay(noSet, tagColors, LabelEditorTargetComponent.FACE);
		...
		tag1Set.add(tag1);
		int colorTag1 = DefaultLabelEditorRenderer.mixColorsOverlay(tag1Set, tagColors, LabelEditorTargetComponent.FACE);
	...
	public void testMixTransparentColors() {
		...
		tag2Set.add(tag2);
		int colorTag2 = DefaultLabelEditorRenderer.mixColorsOverlay(tag2Set, tagColors, LabelEditorTargetComponent.FACE);
		...
		tag12Set.add(tag1);
		tag12Set.add(tag2);
		int colorTag12 = DefaultLabelEditorRenderer.mixColorsOverlay(tag12Set, tagColors, LabelEditorTargetComponent.FACE);
		...
		tag21Set.add(tag2);
		tag21Set.add(tag1);
		int colorTag21 = DefaultLabelEditorRenderer.mixColorsOverlay(tag21Set, tagColors, LabelEditorTargetComponent.FACE);
